		...
		<div class="row no-gutters login-page-v1">
			...
			<div class="col-12 col-md-6 col-lg-4 bg-white d-flex align-items-center">
				<div class="col-12 p-4 my-4 sign-in-v1">
					<h5 class="mb-4 text-center" id="mensagem">
...
?>
					<form id="login-form" class="form-horizontal" role="form" action="login.php" method="post">
						...
						<div class="form-group">
							<button type="button" class="btn btn-warning btn-block flat" name="btn-login" id="btn-login">Logar</button>
						</div>
						<!--div class="form-group">
  ...
  <script type="text/javascript" src="help/req.js"></script> 
